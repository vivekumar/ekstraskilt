    ...
    <div class="container">
                ...
                <div class="col-lg-9">
                    <div class="widget widget-newsletter form-wrapper form-wrapper-inline">
                        <div class="newsletter-info mx-auto mr-lg-2 ml-lg-4">
                            <h4 class="widget-title">Abonner på vårt nyhetsbrev</h4>
                            <p>Få all den nyeste informasjonen, salg og tilbud.</p>
                        </div>
                        <form action="#" class="input-wrapper input-wrapper-inline">
                            <input type="email" class="form-control" name="email" id="email"
                                placeholder="E-postadresse her..." required />
                            <button class="btn btn-primary btn-rounded btn-md ml-2" type="submit">Abonnere<i
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="widget widget-info">
                        <h4 class="widget-title">Kontaktinfo</h4>
                        <ul class="widget-body">
                            ...
                            <li>
                                <label>E-post:</label>
                                <a href="mailto:post@ekstraskilt.no"><span>post@ekstraskilt.no</span></a>
                            </li>
                            <li>
                                <label>Adresse:</label>
                                <a href="#">c/o Promerch AS Stasjonsveien 21, 1550 Hølen</a>
                            </li>
                            <li>
                                <label>Orgnr.: </label>
                                <a href="#">NO929010450MVA</a>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="widget ml-lg-4">
                        <h4 class="widget-title">Min konto</h4>
                        <ul class="widget-body">
                            <li><a href="about.php">Om oss</a></li>
                            <li><a href="products.php">Product</a></li>
                            <li><a href="term-condition.php">Returnerer</a></li>
                            <li><a href="term-condition.php">Tilpasset service</a></li>
                            <li><a href="term-condition.php">Vilkår og betingelser</a></li>
                            <li>
                                <label>Åpningstider Kundeservice:</label>
                            </li>
                            <li>
                                <a href="javascript:;">Mandag – Fredag / 08.00 – 16.00</a> <br />
                                <a href="javascript:;">Lørdag – Søndag: Stengt</a>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="widget ml-lg-4">
                        <h4 class="widget-title">Kontaktinfo</h4>
                        <ul class="widget-body">
                            <li><a href="account.php">Logg inn</a></li>
                            <li><a href="cart.php">Se handlekurv</a></li>
                            <li><a href="wishlist.php">min ønskeliste</a></li>
                            <li><a href="track.php">Spor min bestilling</a></li>
                            <li><a href="faq.php">FAQ's</a></li>
                            <li>
                                <label>Åpningstider Produksjon:</label>
                            </li>
                            <li>
                                <a href="javascript:;">Mandag – Fredag / 08.00 – 16.00</a> <br />
                                <a href="javascript:;">Lørdag – Søndag: Stengt</a>
        ...
        <div class="footer-bottom">
            ...
            <div class="footer-center">
                <p class="copyright">Promerch AS &copy; 2023. All Rights Reserved</p>
            </div>
...
<div class="sticky-footer sticky-content fix-bottom">
    ...
    <a href="product.php" class="sticky-link">
    ...
    <section class="chatbox-panel">
        <header class="chatbox-panel__header">
            ...
            <aside style="flex:3;text-align:right;">
                ...
                <button class="chatbox-panel-close"><i class="fas fa-times" aria-hidden="true"></i></button>
            </aside>
        </header>
