                                        ...
                                        <div class="container">
                                            <div class="row">
                                                <div class="col-6 col-sm-4 col-md-4 col-lg-2">
                                                    <ul>
                                                        <li><a href="products.php"><img src="images/menu/banner-1.jpg"
                                                                    alt="Menu banner" />N Merker</a></li>
                                                    </ul>
                                                </div>
                                                <div class="col-6 col-sm-4 col-md-4 col-lg-2">
                                                    <ul>
                                                        <li><a href="products.php"><img src="images/menu/banner-2.jpg"
                                                                    alt="Menu banner" />Beskyttelse</a></li>
                                                    </ul>
                                                </div>
                                                <div class="col-6 col-sm-4 col-md-4 col-lg-2">
                                                    <ul>
                                                        <li><a href="products.php"><img src="images/menu/banner-3.jpg"
