...
<main class="main order">
    <div class="page-content pt-7 pb-10 mb-10">
        <div class="step-by pr-4 pl-4">
            ...
            <h3 class="title title-simple title-step active"><a href="order.php">3. Order Complete</a></h3>
        </div>
        <div class="container mt-8">
            ...
            <div class="order-results">
                ...
                <div class="overview-item">
                    <span>Date:</span>
                    <strong>September 02, 2023</strong>
                </div>
                <div class="overview-item">
                    <span>Email:</span>
                    <strong><a href="mailto:post@ekstraskilt.no" class="mail">post@ekstraskilt.no</a></strong>
                </div>
                <div class="overview-item">
                    <span>Total:</span>
            ...
            <div class="order-details">
                <table class="order-details-table">
                    ...
                    <tbody>
                        <tr>
                            <td class="product-name">Ekstra skilt – for sykkelstativ <span> <i class="fas fa-times"></i>
                                    1</span></td>
            ...
            <div class="address-info pb-8 mb-6">
                ...
                <p class="email"><a href="mailto:post@ekstraskilt.no" class="mail">post@ekstraskilt.no</a></p>
            </div>
            <a href="product.php" class="btn btn-icon-left btn-dark btn-back btn-rounded btn-md mb-4"><i
