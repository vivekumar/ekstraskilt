            ...
            <div class="row">
                <div class="col-lg-8 col-md-12 pr-lg-4">
                        ...
                        <tbody>
                            <tr>
                                <td class="product-thumbnail">
                                    <figure>
                                        <a href="product-detail.php">
                                            <img src="{{URL::asset('front/images/')}}/wishlist/product-1.jpg" width="100" height="100"
                                                alt="product">
                                        </a>
                                    </figure>
                                </td>
                                <td class="product-name">
                                    <div class="product-name-section">
                                        <a href="product-detail.php">Lorem ipsum dolor sit</a>
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td class="product-thumbnail">
                                    <figure>
                                        <a href="product-detail.php">
                                            <img src="{{URL::asset('front/images/')}}/wishlist/product-2.jpg" width="100" height="100"
                                                alt="product">
                                        </a>
                                    </figure>
                                </td>
                                <td class="product-name">
                                    <div class="product-name-section">
                                        <a href="product-detail.php">Lorem ipsum dolor sit amet</a>
                                    </div>
                                </td>
                                <td class="product-subtotal">
                    ...
                    <div class="cart-actions mb-6 pt-4">
                        <a href="product.php" class="btn btn-dark btn-md btn-rounded btn-icon-left mr-4 mb-4"><i
