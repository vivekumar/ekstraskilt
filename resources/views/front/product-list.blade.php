                    ...
                    <nav class="toolbox sticky-toolbox sticky-content fix-top">
                        ...
                        <div class="toolbox-right">
                            ...
                            <div class="toolbox-item toolbox-layout">
                                <a href="products-list.php" class="d-icon-mode-list btn-layout active"></a>
                                <a href="products.php" class="d-icon-mode-grid btn-layout"></a>
                            </div>
                        </div>
                    </nav>
                    ...
                    <div class="product-lists product-wrapper">
                        <div class="product product-list">
                            <figure class="product-media">
                                <a href="product.html">
                                    <img src="front/images/shop/13.jpg" alt="product" width="260" height="293">
                                </a>
                        ...
                        <div class="product product-list">
                            <figure class="product-media">
                                <a href="product.html">
                                    <img src="front/images/shop/1.jpg" alt="product" width="260" height="293">
                                </a>
                                <div class="product-label-group">
                                    <label class="product-label label-new">new</label>
                            ...
                            <div class="product-details">
                                <div class="product-cat">
                                    <a href="shop-list-mode.html">Bags & Backpacks</a>
                                </div>
                                <h3 class="product-name">
                        ...
                        <div class="product product-list">
                            <figure class="product-media">
                                <a href="product.html">
                                    <img src="front/images/shop/2.jpg" alt="product" width="260" height="293">
                                </a>
                                <div class="product-label-group">
                        ...
                        <div class="product product-list">
                            <figure class="product-media">
                                <a href="product.html">
                                    <img src="front/images/shop/4.jpg" alt="product" width="260" height="293">
                                </a>
                            </figure>
                            <div class="product-details">
                                <div class="product-cat">
                        ...
                        <div class="product product-list">
                            <figure class="product-media">
                                <a href="product.html">
                                    <img src="front/images/shop/14.jpg" alt="product" width="260" height="293">
                                </a>
                            </figure>
                            <div class="product-details">
                                <div class="product-cat">
                                    <a href="shop-list-mode.html">men</a>
                                </div>
                                <h3 class="product-name">
                                ...
                                <div class="ratings-container">
                                    ...
                                    <a href="product.html" class="rating-reviews">( 28 reviews )</a>
                                </div>
                                <p class="product-short-desc">
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
                                    tempor
                        ...
                        <div class="product product-list">
                            <figure class="product-media">
                                <a href="product.html">
                                    <img src="front/images/shop/12.jpg" alt="product" width="260" height="293">
                                </a>
                                <div class="product-label-group">
                            ...
                            <div class="product-details">
                                <div class="product-cat">
                                    <a href="shop-list-mode.html">Watches</a>
                                </div>
                                <h3 class="product-name">
