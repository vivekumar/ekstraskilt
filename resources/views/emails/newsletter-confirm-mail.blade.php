                                      ...
                                      <tbody>
                                        <tr>
                                          <td align="center" style="padding: 0px; text-size-adjust: 100%; color: rgb(51, 51, 51); font-family: Tahoma, Arial, sans-serif; border-collapse: collapse; border-spacing: 0px; border-width: 0px; border-style: none; font-size: 18px;">
                                            <img class="model" src="http://localhost/signaco/front/img/logo.png" style="display: block; width: 600px; height: 283px; border-width: 0px; border-style: none; line-height: 100%; max-width: 100%; outline-width: medium; outline-style: none; text-decoration: none; color: rgb(51, 51, 51); font-size: 20px; font-weight: 700; border-radius: 10px;" alt="Image" width="600" height="150">
                                          </td>
                                        </tr>
                                      </tbody>
                                    </table>
                                ...
                                <div class="definition-parent">
                                  <div class="text-element paragraph">
                                    <div style="color: rgb(51, 51, 51); font-family: Arial, sans-serif; font-size: 18px; line-height: 125%; font-weight: 400; text-align: left;">
                                      ...
                                      <p style="color: rgb(51, 51, 51); font-family: Arial, sans-serif; font-size: 19px; line-height: 125%; font-weight: 400; text-align: center;">Hi 

                                       Thanks so much for signing up for the signaco newsletter! <br>
                                      </p>

                                      <p style="color: rgb(51, 51, 51); font-family: Arial, sans-serif; font-size: 19px; line-height: 125%; font-weight: 700; text-align: center; margin-top: 24px">www.signaco.si &#10084;
                                      </p>
                                    </div>
                                  </div>
                                </div>
