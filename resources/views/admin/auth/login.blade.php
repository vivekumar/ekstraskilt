                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted">Sign in to continue to {{env('SITE_NAME')}}.</p>
                                </div>
                                <div class="p-2 mt-4">
                                    @if (session('msg'))
                                    ...
                                    <form action="{{url('admin/authenticate')}}" method="post">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="position-relative auth-pass-inputgroup mb-3">
                                                <input type="password" class="form-control pe-5" name="password" placeholder="Enter password" id="myPassword">
                                                <button class="btn btn-link position-absolute end-0 top-0 text-decoration-none text-muted shadow-none" type="button" id="password-addon" onclick="showMyPassword()"><i class="ri-eye-fill align-middle"></i></button>
                        ...
                        <div class="mt-4 text-center">
                            <p class="mb-0">Back to website ? <a href="{{url('/')}}" class="fw-semibold text-primary text-decoration-underline" target="_blank"> Click here </a> </p>
                        </div>
